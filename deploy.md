...
```bash
git remote add origin git@github.com:eliavw/dummynator.git
git remote -v
...
```bash
git remote add origin git@github.com:eliavw/dummynator.git; git remote -v; git push origin master
```
...
```bash
conda env create -f dependencies-deploy.yaml -n dummynator
```
...
conda env update -n dummynator -f dependencies-develop.yaml
```
...
```bash
conda activate dummynator
python -m ipykernel install --user --name dummynator --display-name "dummynator"
```
...
1. Go to the [Travis](https://travis-ci.com/eliavw/dummynator) page of this repo.
2. See if it ran.
...
and your site should be online at; [https://eliavw.github.io/dummynator/](https://eliavw.github.io/dummynator/). 
...
> Multi-directional dummy predictor, cf. https://eliavw.github.io/dummynator
